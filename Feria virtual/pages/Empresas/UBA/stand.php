...
<html>
    <head>
        <title>Posgrados UBA - Stand</title>
	<script type="text/javascript" src="js/rotativoUBA.js"></script>
		...
		<div class="headerInfo leftSide opensans textShadow"> 
		    ...
		    <body onload="banner()">
                    ...
                    <div class="social" style="width: 12%">
                        <!-- Facebook -->
                        <a href="https://www.facebook.com/economicas.uba" target="_blank">
                            <img src="http://www.simplesharebuttons.com/images/somacro/facebook.png" alt="Facebook" />
                        </a>
                        <a href="mailto:posgrado@econ.uba.ar" target="_blank">
