...
<html>
    <head>
        <title>AArEII - Encontrá+ Virtual 2014</title>
...
<!-- FANCYBOX --> 
    ...
    <body>
        <div class="wrapperMedium">
			...
			<a class="videoStandTV" title="Viví la Ingeniería Industrial" href="https://www.youtube.com/watch?v=-ZVon3YVvJ4">
...
<!-- REDES SOCIALES -->
                    <div class="social" style="width: 12%">
                        <!-- Facebook -->
                        <a href="https://www.facebook.com/AArEII" target="_blank">
                            <img src="http://www.simplesharebuttons.com/images/somacro/facebook.png" alt="Facebook" />
                        </a>
                        <a href="https://twitter.com/aareiioficial" target="_blank">
                            <img src="http://www.simplesharebuttons.com/images/somacro/twitter.png" alt="Twitter" />
                        </a>
                        <a href="https://www.youtube.com/user/videosaareii" target="_blank">
